...
class GameComponent extends Component {
    ...
    dessiner(){
        const canvas = this.refs.canevas;
        console.log(canvas);
        const ctx = canvas.getContext("2d");
    
            this.rectArrondi(ctx, 12, 12, 150, 150, 15);
            this.rectArrondi(ctx, 19, 19, 150, 150, 9);
            this.rectArrondi(ctx, 53, 53, 49, 33, 10);
            this.rectArrondi(ctx, 53, 119, 49, 16, 6);
            this.rectArrondi(ctx, 135, 53, 49, 33, 10);
            this.rectArrondi(ctx, 135, 119, 25, 49, 10);
          ...
          return (
              <div className="game">
                <div className="pacman">
                    <canvas ref="canevas"></canvas>
                </div>
                <div className="pac">
                    <Button onClick={(e) => this.dessiner(e)}></Button> 
                </div>
            </div>
          );
    }
